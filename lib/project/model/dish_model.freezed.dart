...
mixin _$DishModel {
 ...
 String? get id; String get name; double get price; bool get isVeg; String get image; double get rating;@TimestampConverter() DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,price,isVeg,image,rating,createdAt);

@override
String toString() {
  return 'DishModel(id: $id, name: $name, price: $price, isVeg: $isVeg, image: $image, rating: $rating, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String? id, String name, double price, bool isVeg, String image, double rating,@TimestampConverter() DateTime? createdAt
});
...
/// Create a copy of DishModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = null,Object? price = null,Object? isVeg = null,Object? image = null,Object? rating = null,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String name,  double price,  bool isVeg,  String image,  double rating, @TimestampConverter()  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DishModel() when $default != null:
return $default(_that.id,_that.name,_that.price,_that.isVeg,_that.image,_that.rating,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String name,  double price,  bool isVeg,  String image,  double rating, @TimestampConverter()  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _DishModel():
return $default(_that.id,_that.name,_that.price,_that.isVeg,_that.image,_that.rating,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String name,  double price,  bool isVeg,  String image,  double rating, @TimestampConverter()  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _DishModel() when $default != null:
return $default(_that.id,_that.name,_that.price,_that.isVeg,_that.image,_that.rating,_that.createdAt);case _:
  return null;
...
class _DishModel implements DishModel {
  const _DishModel({this.id, this.name = '', this.price = 0, this.isVeg = true, this.image = '', this.rating = 0, @TimestampConverter() this.createdAt});
...
/// Create a copy of DishModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = null,Object? price = null,Object? isVeg = null,Object? image = null,Object? rating = null,Object? createdAt = freezed,}) {
